...
class Trace:
    ...
    def add_llm_step(self, input_prompt: str, model: str = "gpt-4o-mini"):
        """Call the LLM and record the resulting step."""
    ...
    def add_tool_step(self, tool: str, tool_function, tool_input: dict):
        """Execute a tool and record the resulting step."""
    ...
    def finish(
        ...
        """Finalize the trace with its output and classification."""
    ...
    def to_dict(self):
        """Return the complete trace as a dictionary."""
